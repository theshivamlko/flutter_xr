...
class FlutterXR {
  /// Constructor for [FlutterXR].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  FlutterXR({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
  ...
  Future<bool> isSpatialEnabled() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.flutter_xr.FlutterXR.isSpatialEnabled$pigeonVar_messageChannelSuffix';
